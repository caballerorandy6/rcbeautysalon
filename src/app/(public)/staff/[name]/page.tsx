...
export async function generateMetadata({ params }: StaffDetailPageProps) {
  ...
  if (!staffMember) {
    return {
      title: "Staff Member Not Found | BS Beauty Salon",
    }
  }

  return {
    title: `${staffMember.name} | BS Beauty Salon`,
    description:
      staffMember.bio || `Book an appointment with ${staffMember.name} at BS Beauty Salon`,
  }
}
