          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="name" placeholder="e.g., Professional Shampoo" />
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="price" type="number" step="0.01" placeholder="28.00" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="comparePrice">Compare at Price ($)</Label>
                  <Input id="comparePrice" type="number" step="0.01" placeholder="35.00" />
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="sku" placeholder="SHMP-001" />
                </div>
                <div className="space-y-2">
