    ...
    data: [
      {
        ...
        sku: 'SHP-001',
        stockQuantity: 50,
        images: ['products/shampoo-premium'],
      ...
      },
      {
        ...
        sku: 'NPL-001',
        stockQuantity: 25,
        images: ['products/nail-polish-red'],
        categoryId: productsCategory.id,
        isActive: true,
        isFeatured: false,
      },
